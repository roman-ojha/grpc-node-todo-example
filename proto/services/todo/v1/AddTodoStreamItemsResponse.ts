...
export interface AddTodoStreamItemsResponse {
  'items'?: (_services_todo_v1_TodoItem)[];
}

export interface AddTodoStreamItemsResponse__Output {
  'items'?: (_services_todo_v1_TodoItem__Output)[];
}
